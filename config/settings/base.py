...
MIDDLEWARE = [
    ...
    # "nanuri.middleware.JsonErrorResponseMiddleware",
]
...
AWS_SNS_PLATFORM_APPLICATION_ARN = None

AWS_S3_CERTIFICATE_BUCKET_NAME = os.environ["AWS_S3_CERTIFICATE_BUCKET_NAME"]
AWS_S3_CERTIFICATE_KEY = os.environ["AWS_S3_CERTIFICATE_KEY"]
